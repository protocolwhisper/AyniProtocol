...
contract AyniVaultFactory {
    ...
    constructor(address vault_blueprint_, address registry_, address owner_) {
        ...
        returns (address vault)
    {
        ...
        require(debt_asset != address(0), "Factory: bad debt asset");
        require(debt_asset.code.length > 0, "Factory: bad debt asset");
        ...
        emit VaultCreated(vault, collateral_token, debt_asset, oracle, vault_owner);
    }

    function create_vault_with_salt(
